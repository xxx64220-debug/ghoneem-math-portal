...
revoke all on function public.daily_state(uuid,text),public.daily_submit(uuid,text,jsonb) from public,anon,authenticated;
grant execute on function public.daily_state(uuid,text),public.daily_submit(uuid,text,jsonb) to service_role;
COMMIT;
